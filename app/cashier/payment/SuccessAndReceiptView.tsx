...
// PERBAIKAN: Impor tipe CartItem untuk type safety yang lebih baik
import { TransactionDetails, CartItem } from "@/app/cashier/types";

export const SuccessAndReceiptView = ({
  details,
}: {
        ...
        <div className="receipt-content">
          ...
          <div className="details">
            ...
            <p>
              ...
              {new Date(details.transactionDate).toLocaleString("id-ID", {
                day: "2-digit",
                month: "short",
                year: "numeric",
                hour: "2-digit",
            ...
            <p>
              <strong>Kasir:</strong> {details.cashierName || "N/A"}
            </p>
          </div>
          <hr />

          <div className="items-container">
            {/* PERBAIKAN: Memberikan tipe eksplisit pada 'item' */}
            {details.items.map((item: CartItem) => (
              <div key={item.id} className="item-block">
                ...
                <div className="item-detail-line">
                  <span>
                    {item.quantity} x @{item.sellPrice.toLocaleString("id-ID")}
                  </span>
                </div>
              </div>
            ))}
      ...
      <style jsx global>{`
        @media print {
          ...
          .item-name {
            ...
            padding-right: 8px; /* Jarak antara nama dan harga */
          }
          .item-total {
            text-align: right;
            white-space: nowrap;
